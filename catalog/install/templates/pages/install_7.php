...
<?php
    ...
    $file_contents = '<?php' . "\n" .
                     ...
                     '' . "\n" .
                     '  Released under the GNU General Public License' . "\n" .
                     '  Modifications applied by Evolve Networks 2007' . "\n" .
                     '*/' . "\n" .
                     '' . "\n" .
...
<table width="95%" border="0" cellpadding="2" class="formPage">
  <tr>
    <td align="center">The configuration was successful!</td></tr><tr>
    <td align="center"><font face="arial" color="red" size="3">The default Administrator Login/Pass is:</font><br><font face="arial" size="2">info@e.volve.net<br>i9u8yyy<P>Please make a note of these as you should change them immediately.<br>To change the Administrator information click on "Administration Tool" below. Login to the admin using the information on this page. Then click on "My Account" to edit.<br> Have fun!</font></td>
 </tr>
</table>
