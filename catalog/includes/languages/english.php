...
define('BOX_HEADING_WHATS_NEW', '<a class="infoBoxHeading" href="products_new.php">What\'s New?</a>');
...
define('BOX_HEADING_REVIEWS', '<a class="infoBoxHeading" href="reviews.php">Reviews</a>');
define('BOX_REVIEWS_WRITE_REVIEW', 'Write a review for this product!');
define('BOX_REVIEWS_NO_REVIEWS', 'There are currently no reviews for this product.');
define('BOX_REVIEWS_TEXT_OF_5_STARS', '%s of 5 Stars!');

// shopping_cart box text in includes/boxes/shopping_cart.php
define('BOX_HEADING_SHOPPING_CART', '<a class="infoBoxHeading" href="shopping_cart.php">Shopping Cart</a>');
...
define('ENTRY_COMPANY_TAX_ID', 'Tax id');
...
define('TEXT_NO_REVIEWS', 'There are currently no reviews for this product.');
...
// BOF Show Price list v.3.5 for SPPC 4.1.1
define('SHOW_PRICE_LIST', 'Retail Price : ');
define('SHOW_YOUR_PRICE', '');
define('REGULAR_PRICE', 'Regular Price : ');
