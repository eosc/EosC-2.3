...
////
// Generate a path to categories - Original tep_get_path
...
//  This line faulty 08.17.06 update    $country = tep_output_string_protected($address['country']['title']);
