...
// BOF New Attributes Sort
		$attributes_sort = tep_db_prepare_input($_POST['attributes_sort']);
// EOF New Attirbutes Sort
...
?>
          ...
          <tr>
<? // Line Change New Attributes Sort ?>
          ...
          <tr class="dataTableHeadingRow">
            ...
            <td class="dataTableHeadingContent">&nbsp;<?php echo TABLE_HEADING_OPT_NAME; ?>&nbsp;</td>
            <td class="dataTableHeadingContent">&nbsp;<?php echo TABLE_HEADING_OPT_VALUE; ?>&nbsp;</td>
<? // Line Added New Attributes Sort ?>
            <td class="dataTableHeadingContent">&nbsp;Attrib Sort&nbsp;</td>
