...
define('TEXT_STATUS_NO_SESSION_BOT', 'Inactive Bot with no session?'); //check if right description
define('TEXT_STATUS_INACTIVE_BOT', 'Inactive Bot with session '); //check if right description
define('TEXT_STATUS_ACTIVE_BOT', 'Active Bot with session '); //check if right description
