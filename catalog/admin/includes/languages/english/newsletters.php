...
define('TEXT_COUNT_CUSTOMERS', '&bull; Customers receiving the newsletter: <font color="#0000ff">%s</font>');
define('TEXT_MODULE', '&bull; Module used to send the newsletter:');
define('TEXT_BULLETIN_NUMB', '&bull; Newsletter number :');
define('TEXT_TITRE_MAIL', '&bull; Title of the newsletter:');
define('TEXT_TITRE_INFO', '&bull; Information about the newsletter &bull;');
define('TEXT_TITRE_VIEW', '&bull; Outline of the newsletter &bull;');
