...
<style type="text/css">
td.seoHead { font-family: Tahoma, Verdana, Arial, sans-serif; color: sienna; font-size: 14px; font-weight: bold; } 
td.seo_subHead { font-family: Tahoma, Verdana, Arial, sans-serif; color: sienna; font-size: 12px; } 
td { font-family: Tahoma, Verdana, Arial, sans-serif; color: #000000; font-size: 12px; } 
</style>
</head>
